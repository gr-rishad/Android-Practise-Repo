...
public class VendorRegistration extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button btnVendorSignUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVendorSignUp = (Button) findViewById(R.id.vendorSignUpButtonId);
        ...
        userOccupation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(VendorRegistration.this, android.R.layout.simple_spinner_item, occupation);
        ...
        userIdentityType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Button btnDismiss = (Button) popupView.findViewById(R.id.dismiss);
                popupSpinner = (Spinner) popupView.findViewById(R.id.popupspinner);
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(VendorRegistration.this, android.R.layout.simple_spinner_item, identity);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                popupSpinner.setAdapter(adapter);
    ...
    public void showDate(View v){
        DialogFragment newFragment = new Sign_Up.DatePickerFragment();
    ...
    public void onClick(View v) {
            ...
            Intent intent;
            switch (v.getId()){
                case R.id.vendorSignUpButtonId:
                    intent = new Intent(VendorRegistration.this,VendorServiceProvidedList.class);
